...
function(object)
{
    ...
    if (showSeparate)
    {
        chrome.contextMenus.create({ id: "subdomain", title: "Search Subdomain", contexts: [ "selection" ], enabled: true });
        chrome.contextMenus.create({ id: "entiredomain", title: "Search Entire Domain", contexts: [ "selection" ], enabled: true });
    }
    else chrome.contextMenus.create({ id: "defaultdomain", title: "Search Default Domain", contexts: [ "selection" ], enabled: true });
